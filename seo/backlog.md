...
- [ ] **Kostnaðargrein um heimagerða pizzu** — _why:_ „verðvaktin" fær þegar 2 impr á stöðu 10; dagsett ISK-verð er einstakt, tilvitnanlegt GEO-efni · _effort:_ M · _files:_ ný síða · _ath:_ Krónan-tengingin var fjarlægð 2026-08-08 (þau hættu að taka við tokeninu okkar), svo verðin þarf úr annarri heimild. Vörunúmerakortið lifir í `src/lib/kronanMapping.ts` ef Krónan opnar API.
