...
export function Footer() {
  ...
  return (
    <footer className="w-full mt-auto bg-(--color-bg-secondary) border-t border-(--color-border) text-(--color-text-secondary)">
      {/* 1080x240 Ad Top of Footer */}
      <div className="w-full py-12 border-b border-(--color-border-light) hidden md:block">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 border-b border-(--color-border-light) pb-12">
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-(--color-border) flex items-center justify-center hover:bg-(--color-brand) transition-colors text-(--color-text-primary)">
            ...
            <div>
              <h4 className="text-lg font-bold mb-6 font-display text-(--color-text-primary)">{t('links_title_1')}</h4>
              <ul className="space-y-3">
                <li><Link href="/flokkar/deig" className="hover:text-(--color-gold-light) transition-colors">Deig</Link></li>
                <li><Link href="/flokkar/sosur" className="hover:text-(--color-gold-light) transition-colors">Sósur</Link></li>
                <li><Link href="/flokkar/ostur" className="hover:text-(--color-gold-light) transition-colors">Ostur</Link></li>
                <li><Link href="/topplisti" className="hover:text-(--color-gold-light) transition-colors">Topplisti</Link></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-lg font-bold mb-6 font-display text-(--color-text-primary)">{t('links_title_2')}</h4>
              <ul className="space-y-3">
                <li><Link href="/um-okkur" className="hover:text-(--color-gold-light) transition-colors">{t('about')}</Link></li>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-wood border-t border-(--color-border-gold) p-2 flex justify-center pb-safe">
